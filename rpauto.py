...
def main(ihc_path, he_path, X, Y,patch_size,region_size):
    ...
    ihc_8192 = core.get_region(ihc_path, x=X, y=Y, width=region_size, height=region_size, scale=1, rotation=0, sessionID=sessionID)
    output_path = os.path.join(folder_path, "ihc.tiff")
    ihc_8192.save(output_path)
    he_8192 = core.get_region(he_path, x=X, y=Y, width=region_size, height=region_size, scale=1, rotation=0, sessionID=sessionID)
    ...
    im = core.get_region(ihc_path, x=xnew, y=ynew, width=region_size, height=region_size, scale=1, rotation=r, sessionID=sessionID)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--region_size", type=int, help="region_size")
    args = parser.parse_args()

    main(args.ihc_file_path, args.he_file_path, args.X, args.Y,args.patch_size, args.region_size)
